...
Jenkins retrieves the project and runs the build.

Maven packages the application as onlinebookstore.war.

The WAR file is deployed to Apache Tomcat.

Tomcat runs the application on an AWS EC2 instance.

The deployed Online Bookstore is verified from a browser.
